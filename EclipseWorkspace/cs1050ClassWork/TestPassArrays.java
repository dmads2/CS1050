...
public class TestPassArrays {
	...
	public static void main(String[] args) {
		...
		//this is giving array2 the memory address from array1
		array2 = array1;
		...
		//starting at index 0, going to length-1 bc index starts at 0
		...
		//calling the creatArray method and giving it a 5
	...
	{
		//this code creates an array of length 5 (index 0 through 4) with each index value being a number from 1 to 10
		//enters a for loop to iterate through each index of the array until the last index
		//returns the array
		...
		return newArray; //returning so we can go back to the main method
	}
	
	public static void displayArray(int passedArray[])
	{
		System.out.println("\t\t\t--In method stack to display passed array--");
		//entering another for loop 
		//the passedArray is full of random numbers created in the createArray method
		//prints out array1[0] = the random number that is contained within each index
			//does this ^ for each index within the array
		for (int i = 0; i < passedArray.length; i++) {
