...
public class CarDealershipTest
{
	...
	public static void main(String[] args)
	{
		...
		try {
			...
			*/
			...
			System.out.println("Error: Can't Upload car information\n" + e.getMessage());
		}
	...
	public static void dealershipSetUp(Dealership dealership, String filename) throws FileNotFoundException 
	{
		...
		// ******* ADD CODE *****
		//i think this is somewhere on the lectures
...
class Dealership {
	...
	public void addCar(Car carToAdd) {
		...
		if (numCars < cars.length) {
			...
			System.out.println("Dealership is full. Couldn't add car" + carToAdd.getMake()
			+ " " + carToAdd.getModel() + " " + carToAdd.getPrice());
		}
